  ...
  return (
    <div className="w-screen h-full flex justify-center items-center py-12">
      ...
      {results && results.length > 0 && (
        <div className="flex justify-center items-center border w-fit rounded-lg p-5 bg-white shadow-md">
          <ul className="menu w-full list-disc text-sky-500 list-inside">
